...
export const KEY_WRITE_ROLES: Record<string, Role[]> = {
  ...
  "ov-produkce-zdenek":     ["admin", "fakturace"],
  "ov-produkce-matej":      ["admin", "fakturace"],
...
export const KEY_READ_ROLES: Record<string, Role[]> = {
  ...
  // Kreativa (dny + odměny produkčního týmu) — jen jednatelé + Dominika.
  // Zaměstnancům jde měsíčně veřejný náhledový odkaz /z/[token] (bez loginu).
  "ov-produkce-zdenek":     ["admin", "fakturace"],
  "ov-produkce-matej":      ["admin", "fakturace"],
  "ov-produkce-grafici":    ["admin", "fakturace"],
  "ov-produkce-pending":    ["admin", "fakturace"],
