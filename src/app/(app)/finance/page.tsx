...
const INCOME_SEED: IncomeItem[] = [
  ...
  // ── Únor — měsíční klienti reální, jednorázové nespecifikovány ─────────────
  { id: 12, mesic: "Únor",  klient: "SENIMED s.r.o.",                  typ: "Měsíční klient", datumZaplaceni: "12.3.2026", castka: 25000, stav: "Zaplaceno" },
  { id: 13, mesic: "Únor",  klient: "STAVOS Brno, a.s.",               typ: "Měsíční klient", datumZaplaceni: "11.3.2026", castka: 30000, stav: "Zaplaceno" },
  { id: 14, mesic: "Únor",  klient: "FIRESTA-Fišer a.s.",              typ: "Měsíční klient", datumZaplaceni: "5.4.2026",  castka: 28500, stav: "Zaplaceno" },
  { id: 15, mesic: "Únor",  klient: "IMTOS spol. s r.o.",              typ: "Měsíční klient", datumZaplaceni: "10.3.2026", castka: 25000, stav: "Zaplaceno" },
  { id: 16, mesic: "Únor",  klient: "Power Plate Česko",               typ: "Měsíční klient", datumZaplaceni: "10.3.2026", castka: 12000, stav: "Zaplaceno" },
  { id: 17, mesic: "Únor",  klient: "ACsport.cz",                      typ: "Měsíční klient", datumZaplaceni: "9.3.2026",  castka: 15000, stav: "Zaplaceno" },
  { id: 18, mesic: "Únor",  klient: "SK Brno Slatina",                 typ: "Měsíční klient", datumZaplaceni: "15.3.2026", castka: 12000, stav: "Zaplaceno" },
  { id: 19, mesic: "Únor",  klient: "DIAM s.r.o.",                     typ: "Měsíční klient", datumZaplaceni: "10.3.2026", castka: 30000, stav: "Zaplaceno" },
  { id: 20, mesic: "Únor",  klient: "MTB CZ s.r.o.",                   typ: "Měsíční klient", datumZaplaceni: "17.3.2026", castka: 30000, stav: "Zaplaceno" },
  { id: 21, mesic: "Únor",  klient: "Jednorázové projekty",            typ: "Jednorázový",    datumZaplaceni: "—",         castka: 87500, stav: "Zaplaceno" },
  // ── Březen — měsíční klienti reální, jednorázové nespecifikovány ───────────
  { id: 22, mesic: "Březen", klient: "SENIMED s.r.o.",                 typ: "Měsíční klient", datumZaplaceni: "13.4.2026", castka: 25000, stav: "Zaplaceno" },
  { id: 23, mesic: "Březen", klient: "STAVOS Brno, a.s.",              typ: "Měsíční klient", datumZaplaceni: "12.4.2026", castka: 30000, stav: "Zaplaceno" },
  { id: 24, mesic: "Březen", klient: "FIRESTA-Fišer a.s.",             typ: "Měsíční klient", datumZaplaceni: "5.4.2026",  castka: 28500, stav: "Zaplaceno" },
  { id: 25, mesic: "Březen", klient: "IMTOS spol. s r.o.",             typ: "Měsíční klient", datumZaplaceni: "11.4.2026", castka: 25000, stav: "Zaplaceno" },
  { id: 26, mesic: "Březen", klient: "Power Plate Česko",              typ: "Měsíční klient", datumZaplaceni: "10.4.2026", castka: 12000, stav: "Zaplaceno" },
  { id: 27, mesic: "Březen", klient: "ACsport.cz",                     typ: "Měsíční klient", datumZaplaceni: "9.4.2026",  castka: 15000, stav: "Zaplaceno" },
  { id: 28, mesic: "Březen", klient: "SK Brno Slatina",                typ: "Měsíční klient", datumZaplaceni: "16.4.2026", castka: 12000, stav: "Zaplaceno" },
  { id: 29, mesic: "Březen", klient: "DIAM s.r.o.",                    typ: "Měsíční klient", datumZaplaceni: "10.4.2026", castka: 30000, stav: "Zaplaceno" },
  { id: 30, mesic: "Březen", klient: "MTB CZ s.r.o.",                  typ: "Měsíční klient", datumZaplaceni: "18.4.2026", castka: 30000, stav: "Zaplaceno" },
  { id: 31, mesic: "Březen", klient: "Jednorázové projekty",           typ: "Jednorázový",    datumZaplaceni: "—",         castka: 142000, stav: "Zaplaceno" },
];
...
const EXPENSE_SEED: ExpenseItem[] = [
  ...
  // ── Únor — stejná struktura, zbytek 11 350 Kč nespecifikován ───────────────
  { id: 20, mesic: "Únor",  dodavatel: "Adam Mendrek",          typ: "Mzdy",      datumZaplaceni: "2.3.2026",  castka: 16900, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 21, mesic: "Únor",  dodavatel: "Jan Kříž",              typ: "Mzdy",      datumZaplaceni: "2.3.2026",  castka: 16900, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 22, mesic: "Únor",  dodavatel: "Tereza Burianová",      typ: "Mzdy",      datumZaplaceni: "2.3.2026",  castka:  5500, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 23, mesic: "Únor",  dodavatel: "Dominika Mendrek",      typ: "Mzdy",      datumZaplaceni: "2.3.2026",  castka:  3000, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 24, mesic: "Únor",  dodavatel: "Tomáš Dang",            typ: "Mzdy",      datumZaplaceni: "2.3.2026",  castka:  2500, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 25, mesic: "Únor",  dodavatel: "Zdeněk Dolíhal",        typ: "Provize",   datumZaplaceni: "3.3.2026",  castka: 20000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 26, mesic: "Únor",  dodavatel: "Martin Fiala",          typ: "Provize",   datumZaplaceni: "2.3.2026",  castka:  3000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 27, mesic: "Únor",  dodavatel: "Matty Hořák",           typ: "Provize",   datumZaplaceni: "2.3.2026",  castka: 12000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 28, mesic: "Únor",  dodavatel: "Patrik Petr",           typ: "Provize",   datumZaplaceni: "2.3.2026",  castka:  3000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 29, mesic: "Únor",  dodavatel: "ChatGPT",               typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   499, stav: "Zaplaceno", poznamka: "AI" },
  { id: 30, mesic: "Únor",  dodavatel: "Apple",                 typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   670, stav: "Zaplaceno", poznamka: "Meta Verified" },
  { id: 31, mesic: "Únor",  dodavatel: "Apple",                 typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   249, stav: "Zaplaceno", poznamka: "iCloud" },
  { id: 32, mesic: "Únor",  dodavatel: "Adobe",                 typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   608, stav: "Zaplaceno", poznamka: "PS+LR edit fotek" },
  { id: 33, mesic: "Únor",  dodavatel: "Freepik",               typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   488, stav: "Zaplaceno", poznamka: "Šablony" },
  { id: 34, mesic: "Únor",  dodavatel: "Higgsfield",            typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   550, stav: "Zaplaceno", poznamka: "AI" },
  { id: 35, mesic: "Únor",  dodavatel: "Artlist.io",            typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   484, stav: "Zaplaceno", poznamka: "Hudba" },
  { id: 36, mesic: "Únor",  dodavatel: "Google",                typ: "Software",  datumZaplaceni: "1.3.2026",  castka:   250, stav: "Zaplaceno", poznamka: "Úložiště" },
  { id: 37, mesic: "Únor",  dodavatel: "Direct",                typ: "Pojištění", datumZaplaceni: "1.3.2026",  castka:   395, stav: "Zaplaceno", poznamka: "Pojištění" },
  { id: 38, mesic: "Únor",  dodavatel: "Různé",                 typ: "Ostatní",   datumZaplaceni: "28.2.2026", castka: 11350, stav: "Zaplaceno", poznamka: "Projektové náklady" },
  // ── Březen — stejná struktura, zbytek 35 651 Kč nespecifikován ─────────────
  { id: 39, mesic: "Březen", dodavatel: "Adam Mendrek",         typ: "Mzdy",      datumZaplaceni: "2.4.2026",  castka: 16900, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 40, mesic: "Březen", dodavatel: "Jan Kříž",             typ: "Mzdy",      datumZaplaceni: "2.4.2026",  castka: 16900, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 41, mesic: "Březen", dodavatel: "Tereza Burianová",     typ: "Mzdy",      datumZaplaceni: "2.4.2026",  castka:  5500, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 42, mesic: "Březen", dodavatel: "Dominika Mendrek",     typ: "Mzdy",      datumZaplaceni: "2.4.2026",  castka:  3000, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 43, mesic: "Březen", dodavatel: "Tomáš Dang",           typ: "Mzdy",      datumZaplaceni: "2.4.2026",  castka:  2500, stav: "Zaplaceno", poznamka: "DPP" },
  { id: 44, mesic: "Březen", dodavatel: "Zdeněk Dolíhal",       typ: "Provize",   datumZaplaceni: "3.4.2026",  castka: 20000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 45, mesic: "Březen", dodavatel: "Martin Fiala",         typ: "Provize",   datumZaplaceni: "2.4.2026",  castka:  3000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 46, mesic: "Březen", dodavatel: "Matty Hořák",          typ: "Provize",   datumZaplaceni: "2.4.2026",  castka: 12000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 47, mesic: "Březen", dodavatel: "Patrik Petr",          typ: "Provize",   datumZaplaceni: "2.4.2026",  castka:  3000, stav: "Zaplaceno", poznamka: "Faktura" },
  { id: 48, mesic: "Březen", dodavatel: "ChatGPT",              typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   499, stav: "Zaplaceno", poznamka: "AI" },
  { id: 49, mesic: "Březen", dodavatel: "Apple",                typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   670, stav: "Zaplaceno", poznamka: "Meta Verified" },
  { id: 50, mesic: "Březen", dodavatel: "Apple",                typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   249, stav: "Zaplaceno", poznamka: "iCloud" },
  { id: 51, mesic: "Březen", dodavatel: "Adobe",                typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   608, stav: "Zaplaceno", poznamka: "PS+LR edit fotek" },
  { id: 52, mesic: "Březen", dodavatel: "Freepik",              typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   488, stav: "Zaplaceno", poznamka: "Šablony" },
  { id: 53, mesic: "Březen", dodavatel: "Higgsfield",           typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   550, stav: "Zaplaceno", poznamka: "AI" },
  { id: 54, mesic: "Březen", dodavatel: "Artlist.io",           typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   484, stav: "Zaplaceno", poznamka: "Hudba" },
  { id: 55, mesic: "Březen", dodavatel: "Google",               typ: "Software",  datumZaplaceni: "1.4.2026",  castka:   250, stav: "Zaplaceno", poznamka: "Úložiště" },
  { id: 56, mesic: "Březen", dodavatel: "Direct",               typ: "Pojištění", datumZaplaceni: "1.4.2026",  castka:   395, stav: "Zaplaceno", poznamka: "Pojištění" },
  { id: 57, mesic: "Březen", dodavatel: "Různé",                typ: "Ostatní",   datumZaplaceni: "31.3.2026", castka: 35651, stav: "Zaplaceno", poznamka: "Projektové náklady" },
];
